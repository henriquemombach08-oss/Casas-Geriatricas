  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-stone-900 dark:text-white">Nova Escala</h1>
          <p className="text-sm text-stone-500 mt-1">Adicione funcionários à escala do mês</p>
        </div>
