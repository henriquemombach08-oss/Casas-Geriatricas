  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Todas as ações críticas realizadas no sistema</p>
      </div>
              ...
              logs.map((log) => (
                <tr key={log.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-500">
                    {log.entityType && <span className="text-xs bg-gray-100 px-2 py-1 rounded-full">{log.entityType}</span>}
                  </td>
